...
abstract class Env {
  static Env create() {
    String encryptionKey =
        "vkEGul/HljJ5RF6Rkc60oXZ334npvi8jTQZLE93SR5E="; // On build, change with your generated encryption key
    String iv =
        "nq2xMPTYlU1r3sxwez54ww=="; // On build, change with your generated iv
